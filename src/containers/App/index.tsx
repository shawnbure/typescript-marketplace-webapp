        ...
        if (getCookie("useDesktopVersionSuggested") != "true") {
            return (
                ...
                >
                    ...
                    <span>
                        To get the best experience, we recommend using the{" "}
                        <b>Desktop</b> version
                    </span>
                    <div>
                        <button
            ...
            <Dapp.Context config={config}>
                <AuthWrapper>
                    <Switch>
                        ...
                        <Route
                            path={[routePaths.token, routePaths.unlistedToken]}
                            exact={true}
                        >
                        ...
                        <Route
                            path={[routePaths.account, routePaths.profile]}
                            exact={true}
                        >
                            <ProfilePage />
                        </Route>
                        ...
                        <Route path={routePaths.activity} exact={true}>
                            <ActivityPage
                                setLoadStage={setLoadBarValue}
                                loadStage={loadBarValue}
                            />
                        </Route>
