...
export const CongratsPage = () => {
    ...
    const { tokenNonce, collectionId, } = useParams<UrlParameters>();
            ...
            <div className="p-homepage_lead-container col-xs-11 col-md-10">
                ...
                <div className="row">
                        ...
                        <div className="row center-xs">
                            ...
                            <h2 className="u-heading-lead u-text-bold u-margin-bottom-spacing-6 u-text-theme-white justify-center"><br/>Congradulations!</h2>
                                ...
                                <h2 className="u-text-bold u-margin-top-spacing-5 u-padding-top-spacing-5 center-xs">You successfully bought {tokenName}!<br/><br/></h2>
