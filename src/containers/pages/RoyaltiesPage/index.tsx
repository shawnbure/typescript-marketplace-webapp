...
export const RoyaltiesPage: (props: any) => any = ({}) => {
  ...
  const [
    getRoyaltiesAmountTemplateTrigger,
  ...
  const [
    getWithdrawMinterTemplateTrigger,
    { data: getWithdrawMinterTemplateData },
  ] = useGetWithdrawMinterTemplateMutation();

  const [
    getWithdrawCreatorRoyaltiesTemplateTrigger,
          ...
          <div className="grid grid-cols-12">
                ...
                <div className="grid grid-cols-9 mb-4">
                  <div className="col-span-12">
                    <input
                      ...
                      type="text"
                      className="text-xl bg-opacity-10 bg-white border-1 border-black border-gray-400 p-2 placeholder-opacity-10 rounded-2 text-white w-full"
                    />
                  </div>
                </div>
                ...
                <div className="text-white mb-4">
                  ...
                  {getRoyaltiesRemainingData?.data && (
                    <p className="text-gray-400">
                      ...
                      epochs to wait until the next withdraw
                    </p>
                  )}
                </div>
            ...
            <div className="col-span-12 lg:col-span-5">
              <form onSubmit={handleSubmitStep2(onSubmitStep2)}>
                ...
                <p className="text-xl mb-2">Contract Address</p>

                <div className="grid grid-cols-9 mb-4">
                  <div className="col-span-12">
                    <input
                      {...registerStep2("contractAddress")}
                      type="text"
                      className="text-xl bg-opacity-10 bg-white border-1 border-black border-gray-400 p-2 placeholder-opacity-10 rounded-2 text-white w-full"
                    />
                  </div>
