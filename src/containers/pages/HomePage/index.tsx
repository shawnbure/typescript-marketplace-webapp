...
export const HomePage = () => {
  ...
  const mapCollectionList = (collectionList: any) => {
    return collectionList.map((userCollection: any) => {
      const { id, name, tokenId, profileImageLink } = userCollection;
      return (
              ...
              <div className={`c-card c-card--homepage-feature`}>
                ...
                <div className="c-card_info">
                  <div className="c-card_details">
                    <span className="c-card_collection-name">{name}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="p-homepage_lead-container col-xs-11 col-md-10">
                ...
                <div className="row">
                  <div className="col-xs-12 col-md-10 col-lg-8">
                    ...
                    <p className="u-text-lead u-text-theme-gray-mid u-margin-bottom-spacing-10">
                      ...
                      <br />
                      <br />
                      Youbei is the 💰-sharing community marketplace for Elrond
                      NFTs.
                    </p>
                  </div>
                </div>
              ...
              <Link to={"/collection/ENFT-e7b4b7"}>
                <div className="u-margin-top-spacing-9">
                  <div className={`c-card c-card--homepage-feature`}>
                    <div className="c-card_img-container">
                      <img
                        src={"./img/collections/regal-eagles/homepage_gif.gif"}
                        className="c-card_img"
                        alt=""
                      />
                    </div>
                    ...
                    <div className="c-card_info">
                      ...
                      />
                      <div className="c-card_details">
                        <span className="c-card_title">{"Regal Eagles"}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="row row--standard-max u-tac">
            ...
            >
              <div className="u-padding-lr-spacing-2">
                ...
                <p>
                  Creators need to register each collection to enable trading on
                  Youbei
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-12">
            {Boolean(collectionVerifiedList.length) ? (
              mapCollectionList(collectionVerifiedList)
            ) : (
              <div className="text-white text-center u-text-normal col-span-12 mr-8 mb-8">
                Currently, There are No Verified Collections
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-12">
            {Boolean(collectionNoteworthyList.length) ? (
              mapCollectionList(collectionNoteworthyList)
            ) : (
              <div className="text-white text-center u-text-normal col-span-12 mr-8 mb-8">
                Currently, There are No Noteworthy Collections
              </div>
            )}
          </div>
